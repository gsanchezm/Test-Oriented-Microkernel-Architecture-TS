...
const gatling1: PerformanceTool = {
  ...
  perf: {
    ...
    scenarios: [
      { name: 'Browse catalog',    rps: 420, p95: 188, errors: 0.12 },
      { name: 'Add to cart',       rps: 312, p95: 244, errors: 0.30 },
      { name: 'Checkout flow',     rps: 188, p95: 412, errors: 1.10 },
      { name: 'Login burst',       rps: 622, p95: 92,  errors: 0.02 },
      { name: 'Search w/ filters', rps: 300, p95: 360, errors: 0.55 },
    ],
  },
};
...
const pixelmatch1: FixtureVisualTool = {
  ...
  diffs: [
    { name: 'Pricing — hero',      baseline: 'pricing-hero',     diffPct: 0.04, status: 'passed' },
