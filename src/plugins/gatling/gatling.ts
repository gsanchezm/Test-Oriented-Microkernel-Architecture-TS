...
} from '@plugins/gatling/actions/GatlingActionContext';
import { getGatlingActionRegistry } from '@plugins/gatling/actions/registerGatlingActions';

const registry = getGatlingActionRegistry();
