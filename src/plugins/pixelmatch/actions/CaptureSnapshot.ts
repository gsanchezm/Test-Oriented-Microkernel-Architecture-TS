...
import { resultPaths, ensureDir } from '@plugins/pixelmatch/support/visual-paths';
...
import { VisualCaptureResult } from '@plugins/pixelmatch/support/visual-result.types';

export const CaptureSnapshotAction: ActionHandler<PixelmatchActionContext> = {
