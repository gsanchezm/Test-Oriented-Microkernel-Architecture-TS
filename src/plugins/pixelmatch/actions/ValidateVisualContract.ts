...
import { VisualValidationResult } from '@plugins/pixelmatch/support/visual-result.types';

export const ValidateVisualContractAction: ActionHandler<PixelmatchActionContext> = {
