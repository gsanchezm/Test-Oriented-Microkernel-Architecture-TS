...
import { resultPaths, ensureDir, VisualPathKey } from '@plugins/pixelmatch/support/visual-paths';
import { writeBaselineFromBuffer } from '@plugins/pixelmatch/support/visual-baseline-policy';
...
export const UpdateBaselineAction: ActionHandler<PixelmatchActionContext> = {
