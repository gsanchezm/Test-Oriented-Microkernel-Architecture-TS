...
import { getPixelmatchActionRegistry } from '@plugins/pixelmatch/actions/registerPixelmatchActions';

const registry = getPixelmatchActionRegistry();
